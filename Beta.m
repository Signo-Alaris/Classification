...
arrayofCenters = {centers1};
arrayofCenters{2} = centers2;
arrayofCenters{3} = centers3;
arrayofCenters{4} = centers4;
arrayofCenters{5} = centers5;
arrayofCenters{6} = centers6;
arrayofCenters{7} = centers7;

arrayofRadii = {radii1};
arrayofRadii{2} = {radii2};
arrayofRadii{3} = {radii3};
arrayofRadii{4} = {radii4};
arrayofRadii{5} = {radii5};
arrayofRadii{6} = {radii6};
arrayofRadii{7} = {radii7};
